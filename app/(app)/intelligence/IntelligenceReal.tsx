  ...
  return (
    <div className="dsk-screen on">
      ...
      <h1 style={{ fontFamily: OUTFIT, fontWeight: 700, fontSize: 'clamp(30px,3.4vw,44px)', letterSpacing: '-.035em', lineHeight: 1.14, margin: '18px 0 0', maxWidth: 960, color: INK }}>
        ...
        <span style={{ color: MUTED }}>Interventions are <span style={{ color: ACCENT }}>holding</span> at <span style={{ color: ACCENT }}><X m="holding" days={range}>{m.holdingPct}%</X></span>, and Popsicle has <span style={{ color: GREEN }}>protected</span> <span style={{ color: GREEN }}>{fmtMoney(m.protectedTotal)}</span> this quarter.</span>
      </h1>
