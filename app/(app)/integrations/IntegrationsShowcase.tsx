...
export const LOGOS: Record<string, React.ReactNode> = {
  pipedrive: <svg width="20" height="20" viewBox="0 0 24 24"><rect width="24" height="24" rx="5" fill="#017737"/><text x="12" y="16.2" textAnchor="middle" fontFamily="Arial,Helvetica,sans-serif" fontWeight="700" fontSize="13" fill="#fff">p</text></svg>,
