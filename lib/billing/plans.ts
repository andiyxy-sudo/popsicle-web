...
export const PLANS: Plan[] = [
  ...
  { id: 'starter', name: 'Starter', price: 499, priceText: '$499', tagline: 'For a small team',
    ...
    selfServe: true,
    features: ['The Concern Engine, on two of your channels', 'Every Concern quotes the message behind it', 'Drafts the reply and takes the action once you approve'] },
  { id: 'growth', name: 'Growth', price: 1999, priceText: '$1,999', tagline: 'For a full revenue team',
    concerns: 5000, concernsText: '5,000 Concerns', sourcesText: 'Every source · per month', teamGuide: '10 to 25 users*',
    selfServe: true,
  ...
  { id: 'pro', name: 'Pro', price: 3999, priceText: '$3,999', tagline: 'For several teams',
    concerns: 12000, concernsText: '12,000 Concerns', sourcesText: 'Every source · per month', teamGuide: '25 to 100 users*',
    selfServe: false,
  ...
  { id: 'enterprise', name: 'Enterprise', price: null, priceText: 'From $8,000', tagline: 'For the whole company',
    concerns: null, concernsText: 'Agreed', sourcesText: 'Every source', teamGuide: '100+ users*',
    selfServe: false,
    available: 'Coming H1 2027',
